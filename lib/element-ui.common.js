	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    class: [
	      ...
	      _vm.iconPosition ? 'el-input__icon--' + _vm.iconPosition : ''
	    ],
	    on: {
	  ...
	  methods: {
	    ...
	    resetInputHeight: function resetInputHeight() {
	      ...
	      this.$nextTick(function () {
	        ...
	        input.style.height = _this7.selected.length === 0 ? (sizeMap[_this7.size] || 30) + 'px' : Math.max(tags ? tags.clientHeight + 2 : 0, sizeMap[_this7.size] || 30) + 'px';
	    ...
	    barStyle: {
	      ...
	      get: function get() {
	        ...
	        this.tabs.every(function (tab, index) {
	          ...
	          if (!tab.active) {
	            offset += $el.clientWidth + _this.$parent.$parent.offset;
	            return true;
	          } else {
